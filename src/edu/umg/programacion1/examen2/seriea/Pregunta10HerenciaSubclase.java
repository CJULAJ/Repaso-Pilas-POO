...
public class Pregunta10HerenciaSubclase {
    ...
    static class Revista extends Publicacion {
        ...
        public Revista(String titulo, String isbn, int numeroEdicion) {
            ...
            super(titulo, isbn); // se llama al constructor
            this.numeroEdicion = numeroEdicion;
        }

        public String fichaCorta() {
            // TODO estudiante: retornar texto con titulo, isbn y numero de edicion
        	 return "Revista: " + titulo + " ISBN: " + isbn + " Edición: " + numeroEdicion;
        }
    }

    /*
     * CONCEPTO:
     *Revista es una Publicacion, hereda titulo e isbn.
     *La subclase aporta el atributo numeroEdicion y un comportamiento específico con fichaCorta
     */
}
